        ...
        <div>
            ...
            <div id="dropdown" className="z-10 hidden bg-black divide-y divide-black rounded-lg shadow w-44">
                ...
                rounded-lg bg-black md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent dark:bg-transparent md:dark:bg-transparent dark:border-gray-700" aria-labelledby="dropdownDefaultButton">
                    <li>
                        <div onClick={() => { setHide("none"); navigate(`/${process.env.REACT_APP_BASE_URL}/leaderboard/webster`); window.scrollTo({ left: 0, top: 0 }); }} className="card block cursor-pointer py-2 pl-3 pr-4 text-gray-900 rounded md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500">WEBSTER</div>
                    </li>
                    <li>
                    ...
                    <li>
                        <div onClick={() => { setHide("none"); navigate(`/${process.env.REACT_APP_BASE_URL}/leaderboard/logicalrhythm`); window.scrollTo({ left: 0, top: document.body.scrollHeight, behavior: "smooth" }); }} className="card block cursor-pointer py-2 pl-9 pr-4 text-gray-900 rounded md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500">LOGICAL RHYTHM</div>
                    </li>
                    <li>
                        <div onClick={() => { setHide("none"); navigate(`/${process.env.REACT_APP_BASE_URL}/leaderboard/softablitz`); }} className="card block cursor-pointer py-2 pl-3 pr-4 text-gray-900 rounded md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500">SOFTABLITZ</div>
                    </li>
                    <li>
                        <div onClick={() => { setHide("none"); navigate(`/${process.env.REACT_APP_BASE_URL}/leaderboard/contrihub`); }} className="card block cursor-pointer py-2 pl-3 pr-4 text-gray-900 rounded md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500">CONTRIHUB</div>
                    </li>
                </ul>
            </div>
