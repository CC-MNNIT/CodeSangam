...
export default function ContrihubLeaderboard() {
  ...
  return (
    <div>
      ...
      <div style={{ paddingLeft: "20px", paddingRight: "20px", paddingTop: "100px", position: "relative", backgroundColor: "rgba(0,0,0,0)", display: "flex", justifyContent: "center", width: "100vw", height: "100vh" }}>
