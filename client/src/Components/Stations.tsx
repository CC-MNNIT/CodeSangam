...
export default function Stations({ leftrotateMoon, rightrotateMoon }: props) {
  ...
  return (
    ...
    <div id="container" style={{ zIndex: "1000", position: "absolute" }}>
      <div
        className="item sm:scale-50 md:scale-75 lg:scale-100"
        style={{ rotate: "89deg" }}
      >
        <Cards
          ...
          url="https://drive.google.com/file/d/1CdEoNCYAUkNg4xwF2Q1R1mx2Q_OydWnL/view?usp=drive_link"
        />
      </div>
      <div
        className="item scale-50 md:scale-75 lg:scale-100"
        style={{ rotate: "161deg" }}
      >
        <Cards
          leftrotateMoon={leftrotateMoon}
      ...
      >
        <Cards
          ...
          teamsize="Team Size: (1 - 3)"
          url="https://drive.google.com/file/d/1ssSEmt2i0Nwdq-HEKmwc36z-V18iFDzD/view?usp=drive_link"
        />
      </div>
    </div>
  );
