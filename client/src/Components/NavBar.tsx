            ...
            <nav style={{ zIndex: "40000000" }} className="bg-transparent fixed w-full top-0 left-0">
                <div className="flex flex-wrap items-center justify-between pt-0 p-4 mt-0 m-3">
                    ...
                    <div className="flex md:order-2">
                        <button onClick={() => navigate("/api/auth")} type="button" className="card text-blue-500 event-selected border-2 rounded-t-lg inline-block p-2 md:hover:text-blue-500">DASHBOARD</button>
