...
const LandingPage = () => {
    ...
    return (
        <div>
            {/* small ------------------------------------ screen -------------------------------- part */}
            <div className="small-screen-landing-page" style={{ overflow: "hidden", height: 1.8 * divHeight }}>
                ...
                {/* cards--- */}
                <div className="scale-95 md:scale-0 lg:scale-0" style={{ zIndex: "500000000000000000000", width: "100%", height: "100vh" }}>
